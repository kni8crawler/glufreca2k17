	...
	<div class="mdl-layout__header-row">
		...
		<li class="mdl-menu__item"><a data-toggle="collapse" data-target="#glufreca2k16" href="#" style="text-decoration:none; color:#37e047;">Glufreca-2k16</a></li>
		 ...
		 <div class="col-xs-10 col-xs-pull-2 mdl-layout--small-screen-only " style="margin-top:5px;">
     		<span class="mdl-layout-title"  style=" font-family: 'Orbitron',sans-serif; font-weight: bold; font-size: 30px; ">Open Hardware Team</span>
		</div>        
		 <div class="col-xs-10 mdl-layout--large-screen-only " style="margin-top:10px;">
     		<span class="mdl-layout-title"  style=" font-family: 'Orbitron',sans-serif; font-weight: bold; font-size: 40px; text-align:center;  ">Open Hardware Team</span>
		</div>
...
//mysqli_autocommit($conn,FALSE);
   $sql = "SELECT *  FROM detailsec ORDER BY name ASC";
